...
class Exp(MyExp):
    def __init__(self):
        ...
        self.ckpt = "/nfs/home/leo0511/Project/Pig/HybridSORT/YOLOX_outputs/yolox_oink_val_hybrid_sort/best_ckpt.pth.tar"
        self.use_byte = True
        self.dataset = "OinkTrack"
        self.inertia = 0.05
        ...
        self.fast_reid_weights = "/nfs/home/leo0511/Project/Pig/HybridSORT/fast_reid/logs/dancetrack/sbs_S50/model_0054.pth"
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False):
        ...
        dataset = MOTDataset(
            data_dir=os.path.join(get_yolox_datadir(), "OinkTrack"),
